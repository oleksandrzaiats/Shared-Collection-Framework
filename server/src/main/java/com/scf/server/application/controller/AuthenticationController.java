...
public class AuthenticationController extends AbstractController {
    ...
    ResponseEntity<?> login(@RequestBody UserDTO userDTO, HttpServletResponse response) {
        ...
        if (authUser != null && PasswordHelper.checkPassword(authUser.getPassword(), userDTO.getPassword())) {
    ...
    ResponseEntity<?> create(@RequestBody UserDTO userDTO) {
        ...
        if (authUser == null) {
            ...
            userDTO.setPassword(PasswordHelper.encodePassword(userDTO.getPassword()));
